...
def main():
    ...
    with open("mp1_distance_predictor/distance_model_weights/{}.json".format(modelname), "w+") as json_file:
        json_file.write(model_json)

    model.save_weights("mp1_distance_predictor/distance_model_weights/{}.h5".format(modelname))
